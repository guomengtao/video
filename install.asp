...
<%
die "暂停安装<br>(*^__^*) ……您已经安装过了，如需要再次安装，请删除该文件的第三行代码即可"
'******************************************************************************************
...
<body>
<div id='installbox'>
	<div class='msgtitle'>Maxcms5.2安装向导 &gt;&gt; <%=title%></div>
	<div class="step">
		<%
...
&nbsp;&nbsp;&nbsp;&nbsp;本协议仅针对当前版本《MaxCMS》V5.1软件有效。本软件受中华人民共和国和著作权法及国际著作权条约和其它知识产权法及条约的保护，其所有知识产权归MAXCMS所有。
...
&nbsp;&nbsp;&nbsp;&nbsp;本软件为免费产品。MAXCMS为本软件产品提供Email/Web等形式的产品支持。 
...
<form action="?action=<%=ac%>&go=save" method="post" enctype="application/x-www-form-urlencoded">
	...
	<p class="blue"><br/>注意：安装Maxcms5.2，需要将网站目录设置修改、写入权限。</p>
