	...
	select case linkType
		...
		case "newssubpage"
			...
			if curPage=1 then
				...
				ftPage="<a href='"&formatArticleLink(currentTypeId, currentId, currentEnname, currentDatetime, "",1)&"'>首页</a>":ltPage="<a href='"&formatArticleLink(currentTypeId, currentId, currentEnname, currentDatetime, "",curPage-1)&"'>上一页</a>"
			end if
			if clng(curPage)=clng(maxpage) then
				ntPage="<em class='nolink'>下一页</em>":lastPage="<em class='nolink'>尾页</em>"
			else
				ntPage="<a href='"&formatArticleLink(currentTypeId, currentId, currentEnname, currentDatetime, "",curPage+1)&"'>下一页</a>":lastPage="<a href='"&formatArticleLink(currentTypeId, currentId, currentEnname, currentDatetime, "",maxpage)&"'>尾页</a>"
			end if
