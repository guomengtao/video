...
'资源API描述 ,替换为贵站的的描述
AddResUrl -1,"","<h3>JJyyzy.com 影音资源库</h3>"
'网站采集页面的地址 和描述 -- 修改成你的网站采集页面所在URL地址: AddResUrl 后面的数字, 是资源站的分类绑定记忆编号,站长自己修改,尽量不跟其它资源站的数字冲突.
AddResUrl 18,"http://www.jjyyzy.com/inc/api.asp","【JJyyzy.com】<font color=""#0000FF"">吉吉影音_JJvod_影视资源站、无弹窗、质量高、更新快</font>"
