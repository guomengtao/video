...
Function GetContentById(Byval vId)
	...
	with templateObj
		...
		.content = replaceStr(.content,"{playpage:textlink}",typeText&"&nbsp;&nbsp;&raquo;&nbsp;&nbsp;"&rsObj("m_name"))
		...
		.parsePlayList vType,vId,vEnname,vDatetime,rsObj("m_playdata"),"play" : .parsePlayList vType,vId,vEnname,vDatetime,rsObj("m_downdata"),"down": .parseIf()
	end with
